...
[`@aws-sdk/client-xray`](https://www.npmjs.com/package/@aws-sdk/client-xray/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-xray@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L+CGeC/Bty81MS5u8DJSdL6uJ2bYOhb/Ry7webLerRGcaCbcgGzVofYQCP6b/QvV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-xray": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-xray@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-xray@3.257.0/index.min.mjs": "sha384-L+CGeC/Bty81MS5u8DJSdL6uJ2bYOhb/Ry7webLerRGcaCbcgGzVofYQCP6b/QvV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-xray/blob/refs/tags/3.257.0/LICENSE
```
